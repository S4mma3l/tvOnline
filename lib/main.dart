...
void main() async {
  ...
  // Pre-configure server if not already done
  if (!AppStorage.isConfigured) {
    await AppStorage.saveServerConfig(
      url: 'https://fplay2.com:8443',
      user: 'Gerardogu',
      pass: 'xfqjE789uN',
    );
  }

  // Preferred orientations (portrait by default, player overrides)
